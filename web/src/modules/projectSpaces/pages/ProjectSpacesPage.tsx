...
import { ScenarioTemplatesPanel } from '../components/ScenarioTemplatesPanel'
      ...
      <main className="project-space-main">
        ...
        {spaceQuery.data ? (
          <ProjectSpaceShell
            ...
            onConfigureLayouts={(selectedId) => navigate(`/project-spaces/${spaceQuery.data.id}/types/${selectedId}/layouts`)}
            onSelectField={(selectedTypeId, selectedId) => navigate(
              `/project-spaces/${spaceQuery.data.id}/types/${selectedTypeId}/fields${selectedId ? `/${selectedId}` : ''}`,
            )}
          />
        ) : null}
      </main>
...
function ProjectSpaceOverview({ space }: { space: UserProjectSpace }) {
  ...
  return (
    <>
      ...
      <ScenarioTemplatesPanel space={space} />
