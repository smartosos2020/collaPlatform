...
export const saveKnowledgeContentBlocks = (spaceId: string, itemId: string, request: { baseVersionNo: number; blocks: KnowledgeContentBlockDraft[] }) => apiPatch<KnowledgeContentDetail>(`${contentPath(spaceId, itemId)}/blocks`, request)
