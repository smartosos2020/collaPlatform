...
export const apiBoundaryRules: ApiBoundaryRule[] = [
  ...
  {
    prefix: '/compat/work-items',
    boundary: 'user-collaboration',
    owner: 'projectSpaces',
    dtoRule: 'location-only legacy WorkItem resolution',
    permissionRule: 'authorize before resolving immutable migration map',
    errorRule: 'stable unavailable or legacy_write_closed; never return legacy content',
    migrationAction: 'keep',
  },
  {
