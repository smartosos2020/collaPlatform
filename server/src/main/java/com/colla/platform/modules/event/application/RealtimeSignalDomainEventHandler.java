...
public class RealtimeSignalDomainEventHandler implements DomainEventHandler {
    ...
    public void handle(EventMessage event) {
        ...
        long sequenceValue = optionalLong(payload, "sourceVersion", event.aggregateSequence());
    ...
    private static long optionalLong(Map<String, Object> payload, String key, long fallback) {
        if (!payload.containsKey(key)) {
            return fallback;
        }
        return requiredLong(payload, key);
    }
