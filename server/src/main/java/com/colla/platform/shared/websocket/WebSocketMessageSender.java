...
public class WebSocketMessageSender {
    ...
    private final Counter legacyEmitted;
    private final Counter legacyBlocked;
    ...
    public WebSocketMessageSender(
        ...
        this.legacyEmitted = meterRegistry.counter("colla.realtime.websocket.legacy.frame", "outcome", "emitted");
        this.legacyBlocked = meterRegistry.counter("colla.realtime.websocket.legacy.frame", "outcome", "blocked");
    ...
    private boolean legacyFramesEnabled() {
        if (properties.isLegacyFramesEnabled()) {
            legacyEmitted.increment();
            return true;
        }
        legacyBlocked.increment();
        return false;
    }
