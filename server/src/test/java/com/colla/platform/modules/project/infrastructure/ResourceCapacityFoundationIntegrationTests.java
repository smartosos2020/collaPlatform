...
class ResourceCapacityFoundationIntegrationTests {
    @Test
    void createsAllocationsRulesDisposableLoadIndexAndReceipts() {
                ...
                """
                    select count(*) from information_schema.tables
                     where table_schema='public' and table_name in (
                       ...
                       'project_resource_capacity_rules',
                       'project_resource_load_index',
                       'project_resource_capacity_commands'
                     )
                    """,
                Integer.class
            ));
                ...
                """
                    select count(*) >= 3 from pg_indexes
                     where schemaname='public'
                       and indexname like 'idx_project_resource_%'
                    """,
                Boolean.class
            ));
